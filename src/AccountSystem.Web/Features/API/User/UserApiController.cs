...
using AccountSystem.Web.Features.Account.Models;
using AccountSystem.Web.Features.API.User.Model;
using AccountSystem.Web.Features.Shared;
using ChangePasswordViewModel = AccountSystem.Web.Models.ManageViewModels.ChangePasswordViewModel;

namespace AccountSystem.Web.Features.API.User
{
    [Route("api/user")]
