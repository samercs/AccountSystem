...
using AccountSystem.Web.Models.ManageViewModels;


namespace AccountSystem.Web.Features.User
{
    [Authorize]
    public class UserController : AppBaseController
    {
        ...
        IAppServices appServices) : base(appServices)
        {
        ...
        public async Task<IActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            await  SendSms(user, "Your security code is: " + code);
        ...
        private Task<Entities.User> GetCurrentUserAsync()
        {
